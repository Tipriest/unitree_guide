...
void GaitGenerator::setGait(Vec2 vxyGoalGlobal, float dYawGoal,
                            float gaitHeight) {
...
Vec3 GaitGenerator::getFootPos(int i) {
  ...
  footPos(0) =
      cycloidXYPosition(_startP.col(i)(0), _endP.col(i)(0), (*_phase)(i));
  footPos(1) =
      cycloidXYPosition(_startP.col(i)(1), _endP.col(i)(1), (*_phase)(i));
...
Vec3 GaitGenerator::getFootVel(int i) {
  ...
  footVel(0) =
      cycloidXYVelocity(_startP.col(i)(0), _endP.col(i)(0), (*_phase)(i));
  footVel(1) =
      cycloidXYVelocity(_startP.col(i)(1), _endP.col(i)(1), (*_phase)(i));
